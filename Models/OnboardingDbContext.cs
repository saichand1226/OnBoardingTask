    ...
    public partial class OnboardingDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer("Data Source=tcp:onboardingdemo.database.windows.net,1433;Initial Catalog=OnboardingDb;User Id=saisqlserver@onboardingdemo;Password=Pass@1234");
            }
        }
